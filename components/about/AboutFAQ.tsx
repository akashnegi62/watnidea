...
const FAQS = [
  {
    question: "What does watNidea actually mean?",
    answer:
      "It’s the highest compliment in the creative world. It’s the moment an idea is so good, it makes you stop and say, “What an idea!” That is the standard we set for every project.",
  },
  {
    question: "Are you a local or global agency?",
    answer:
      "We are Digital-First. While we have our roots, we architect identities for brands across the globe, operating at the speed of the internet.",
  },
  {
    question: "Do you work with startups?",
    answer:
      "We love them. We specialize in taking “Phase 0” ideas and giving them the identity they need to secure the bag.",
  },
  {
    question: "What services do you provide?",
    answer:
      "watNidea is a full-service powerhouse offering branding, AEO/SEO, web development, social media strategy, video production, and performance marketing.",
  },
];
